...
└─ lua
    ...
    │	├─ extra <<-- Here's a folder where old configurations are stored, in case you wish to personally roll back.
	...
	├─ extra <<-- This folder stores plugins that have either been used in the past and kept around OR plugins I have used during testing but kept disabled.
