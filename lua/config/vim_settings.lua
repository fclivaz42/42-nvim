...
vim.keymap.set('n', '<C-j>', '<Left>', { desc = 'Move focus to the left window' })
vim.keymap.set('n', '<C-l>', '<Right>', { desc = 'Move focus to the right window' })
vim.keymap.set('n', '<C-k>', '<Down>', { desc = 'Move focus to the lower window' })
vim.keymap.set('n', '<C-i>', '<Up>', { desc = 'Move focus to the upper window' })
